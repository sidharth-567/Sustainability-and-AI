...
if __name__ == "__main__":
    ...
    model = TimeSeriesTransformer(input_dim=51,output_dim=39,d_model=1024,nhead=8,num_layers=8,dropout=0.3,weight_decay=0.01,max_lr=1e-3,min_lr=1e-5,warmup_epochs=5,max_epochs=100)
